...
game.saveStates()
time.sleep(2)
print(len(player1.Q),len(player2.Q))
...
player2=Qlearning()
#player1.epsilon = 0
#player1.loadQtable("player1states")
#print(len(player1.Q))
game.startGame(human,player2)#playerX, playerO
#game.startGame(player1,human)#playerX, playerO
game.reset()
game.render()
'''
'''
...
while (running == 1):
    if(game.humanTurn):
        ...
        while event.type!=pygame.MOUSEBUTTONDOWN:
            ...
            if event.type == pygame.QUIT:
                ...
                break
        print("mouse down")
        reward,done = game.updateState(game.humman)
        print(reward,done)
        game.showboard()
        if(done):
            time.sleep(1)
        ...
        #moves=rand.move(game.possible_moves())
        moves = player1.epslion_greedy(game.board, game.possible_moves())
        #moves = player2.epslion_greedy(game.board, game.possible_moves())
        print("computers's turn",moves)
        reward, done = game.drawMove(moves,game.computer)
        print(reward, done)
        game.showboard()
        if (done):
            time.sleep(1)
    ...
    game.humanTurn = not game.humanTurn
...
player2.epsilon = 0
game.startGame(human,player2)#playerX, playerO
#game.startGame(rand,human)#playerX, playerO
game.reset()
...
human=Humanplayer()
rand=Randomplayer()
#game.startGame(human,rand)#playerX, playerO
game.startGame(rand,human)#playerX, playerO
game.reset()
